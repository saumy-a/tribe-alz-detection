...
#================================================================
#
# Usage: ./download_oasis_pup.sh <input_file.csv> <directory_name> <nitrc_ir_username>
# 
# Download PET Unified Pipeline (PUP) files from OASIS3 or OASIS4 on NITRC IR and organize the files
#
# Required inputs:
